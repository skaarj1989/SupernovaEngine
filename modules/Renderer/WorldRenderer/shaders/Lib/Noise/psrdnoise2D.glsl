#ifndef _PSRD_NOISE_2D_GLSL_
#define _PSRD_NOISE_2D_GLSL_
...
//
vec3 psdnoise(vec2 pos, vec2 per) { return psrdnoise(pos, per, 0.0); }
...
// at the minimal cost of three extra additions.
//
float psnoise(vec2 pos, vec2 per) { return psrnoise(pos, per, 0.0); }
...
// at the minimal cost of three extra additions.
//
vec3 sdnoise(vec2 pos) { return srdnoise(pos, 0.0); }
...
//
//float snoise(vec2 pos) { return srnoise(pos, 0.0); }
